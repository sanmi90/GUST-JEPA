"""Generate split_v2.json from raw_cases_inventory_v2p1.yaml.
...
INVENTORY_PATH = REPO / "data_manifest" / "raw_cases_inventory_v2p1.yaml"
OUTPUT_PATH = REPO / "configs" / "splits" / "split_v2p1.json"
