...
% legible note. In review mode the paper is widened to 236mm and the extra
% 62mm is given to the right margin; the text block keeps its exact position
% and its 32pc measure, so line breaking and pagination are unchanged and the
% annotated PDF paginates identically to the clean one. \@twosidefalse and
% the equalised side margins force every note into the right margin
% (marginnote picks its side from \if@twoside).
% ===========================================================================
...
\ifreviewmarks
  \AtBeginDocument{%
    ...
    \setlength\marginparwidth{46mm}%
    \setlength\marginparsep{5mm}%
    \setlength\marginparpush{4\p@}%
    \renewcommand*{\marginfont}{\normalfont}%
  }
  \pdfpagewidth=236mm
  \special{papersize=236mm,247mm}
\fi
