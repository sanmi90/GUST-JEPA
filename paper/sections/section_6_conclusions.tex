...
forward, the predictor tracks the encounter as consistent confirmation rather than
as a validated forecast. Because the predictive encoder also differs in architecture and
...
estimator would exploit. Three facts bound the result: the wall-normal offset is
weakly resolved, the mid-plane representation reaches a three-dimensional
observability boundary at $|G| = 4$, and the rollout error still exceeds the
tolerance a closed-loop control demonstration would require.
