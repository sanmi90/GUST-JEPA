...
intervals are in figure~\ref{fig:cube_deltas} and appendix~\ref{app:nearbody}.
...
two claims rest on different comparisons and fail independently.

\begin{figure}
  \centering
  \includegraphics[width=0.66\linewidth]{sections/figures/results/fig_cube_health_v4.pdf}
  \caption{The conditioning cube on the lift and wake axes: final participation
