...
\StaticInv{} posts the ladder's single large-error encounter, its impact-phase
...
\begin{figure}
  ...
  \caption{Phase-resolved lift tracking with the two-stage production filter
  (the estimator adopted for the performance envelope) on the \TestSplit{} set
  ($n = 42$
