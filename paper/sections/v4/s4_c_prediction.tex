...
\subsection{Advancing the state: forecasting without an oracle}
...
\S\ref{sec:methods_closure} left open: one direct forecaster
...
$R^2 = \RexFamClw{}$ for the flagship and \RexFamCln{} for CLN against
\RexFamAeLw{} for the reconstructive anchor, three operator-training seeds
per family on test\_b, with the CLN latents the most forecastable of all
...
decoded lift closes at \ArFortyClw{} on the flagship latents and
\ArFortyCln{} on CLN. The direct forecaster, emitting all forty steps in
...
\begin{figure}
  ...
  \begin{subfigure}{\linewidth}
    ...
    \caption{}
  \end{subfigure}
  \caption{Forecasting the state on test\_b. (a)~Decoded lift $R^2$ of the
  shared direct forecaster per family (three operator seeds each, bars at
