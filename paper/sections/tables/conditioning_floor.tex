% SUPERSEDED / NOT \input: the live conditioning-only floor is inlined in
% section_4_results.tex at the H=16 forecast horizon (frame-matched). This file is
% the older impact-frame version, retained only for provenance; do not \input it
% (it shares the label tab:conditioning_floor with the live table and its numbers
% are the impact-frame floor, not the H=16 floor reported in the paper).
