...
\begin{table}
  ...
  \fittab{\begin{tabular}{l c c c c c c c c}
    \multicolumn{9}{c}{\textit{(a) Representational closure: mean absolute error, and the wake-enstrophy $R^2$}}\\
    \toprule
    Baseline & $d$ & $C_L$ & $C_D$ & $I_y$ & wake-enst.\ & circ.\ pos.\ & circ.\ neg.\ & wake $R^2$ \\
    \midrule
    JEPA   & 64 & \textbf{0.624} & 0.301 & \textbf{1.901} & \textbf{29.83} & \textbf{0.801} & \textbf{0.715} & \textbf{0.75} \\
    JEPA   & 32 & 0.675 & \textbf{0.246} & 2.976 & 37.99 & 1.084 & 1.061 & 0.74 \\
