...
% Block-diagram alternative (fig1b_jepa_blockdiagram) demoted from the main text in
% the JFM hardening pass to keep a single architecture schematic (Fig.~1) plus
% Table~1; the tikz asset is retained under sections/figures/tikz/ for reuse.
