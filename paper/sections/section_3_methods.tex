...
transport-consistent under the predictor keeps each observable recoverable along the
rollout, while one that drifts off the manifold loses it. Given a ground-truth
