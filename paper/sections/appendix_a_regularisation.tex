...
training predictor is a residual U-Net over the $24 \times 12$ latent map, into
which the pooled state is lifted by a parameter-free broadcast; it takes the two
most recent latent maps and produces the next, and training minimises the
multi-step open-loop rollout loss over eight steps, with no teacher forcing,
