...
model. The downstream forecast operator used for the merit of
table~\ref{tab:closure} and for the ensemble filter
(\S\ref{sec:methods_estimator}) is a matched autoregressive transformer of the
training predictor's class, refitted on each frozen latent identically across
families.
