...
reconstructive-autoencoder latents comparably and placing the predictive flagship
...
own pooled trajectories, where it is stable, and the flagship's own co-trained
