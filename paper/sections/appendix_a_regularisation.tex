...
reports the in-distribution training fit of the forecast rollout that the held-out
closure of \S\ref{sec:res_closure} must be read against. The predictive latent
attains the highest training fit, but this is an in-distribution number, not the
held-out result: the ordering of the families is established by the representational
...
\begin{table}
  ...
  twelve tests of the table (the pre-registered D165 family correction). Bold marks
  ...
  interval. All six observables are shown, not a selected subset.}
  ...
  \fittab{\begin{tabular}{l l r c l r}
    ...
    \midrule
    % rows generated by scripts/session28/emit_paired_table.py from the B6 harvest
    repr.\ & $C_L$ & $\mathbf{+0.552}$ & $[+0.241, +0.949]$ & $34/42$, $p=3.4{\times}10^{-5}$ & $\mathbf{4.1{\times}10^{-4}}$ \\
    repr.\ & $C_D$ & $+0.134$ & $[+0.00847, +0.309]$ & $25/42$, $p=0.14$ & $0.7$ \\
    repr.\ & $I_y$ & $-0.681$ & $[-1.4, +0.0743]$ & $17/42$, $p=0.92$ & $1$ \\
    repr.\ & wake-enst.\ & $\mathbf{+33.6}$ & $[+7.79, +58.7]$ & $30/42$, $p=0.004$ & $\mathbf{0.04}$ \\
    repr.\ & circ.\ pos.\ & $+0.398$ & $[+0.0384, +0.912]$ & $27/42$, $p=0.044$ & $0.35$ \\
    repr.\ & circ.\ neg.\ & $\mathbf{+0.944}$ & $[+0.302, +1.97]$ & $33/42$, $p=1.4{\times}10^{-4}$ & $\mathbf{0.0015}$ \\
    \midrule
    ...
    forecast & circ.\ neg.\ & $\mathbf{+0.708}$ & $[-0.0103, +1.72]$ & $30/42$, $p=0.004$ & $\mathbf{0.04}$ \\
    \bottomrule
  \end{tabular}}
\end{table}
