...
consistency failure under the fixed criterion of \S\ref{sec:methods_lae} is a
transformer-forecast phenomenon: the linear filter with encoded
observations posts zero consistency failures where the transformer stack posts
...
degrades gracefully; every-frame pressure is necessary for the
