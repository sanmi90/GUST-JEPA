...
\begin{figure}
  ...
  separate the families; the separation emerges down the chain, at the wake
  readout, the wall recovery and the boundary filter. The reconstruction column
  is the Fukami lineage, its field cell the wake-headed variant that alone carries
  a decoder; at $|G| = 4$ it fails to track on almost every encounter.}
