...
\TestSplit{} recovery rows, the \BoundarySplit{} set untouched; \S\ref{sec:res_wall}), so the case for
...
on the as-built model and its rollout: the \PredState's own predictor forecasts
