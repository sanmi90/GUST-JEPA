...
\begin{tikzpicture}[
  ...
  \node[predictor, below right=3mm and 5mm of zt] (pred)
    {\textbf{matched predictor} $P$ \\[1pt] unconditional, rollout to $H$};
  ...
  \node[align=center, font=\footnotesize\itshape, below=7mm of pred]
    {The predictor (unconditional, no gust parameters) and probe family $g$ use the
     same architecture and protocol, trained separately for each encoder family.};
