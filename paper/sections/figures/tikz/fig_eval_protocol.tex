...
\begin{tikzpicture}[
  ...
  \node[predictor, below right=3mm and 5mm of zt] (pred)
    {\textbf{shared predictor} $P$ \\[1pt] rollout to $H$};
  ...
  \node[align=center, font=\footnotesize\itshape, below=4mm of cond]
    {The predictor, the conditioning $\mathbf{c}$, and the probe family $g$ are
     held fixed across the three encoder families.};
