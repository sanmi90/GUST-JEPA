...
\begin{figure}
  ...
  \caption{Estimator calibration and selection (\TestSplit{} and \ValSplit{}
  sets). (top left) The impact-phase estimator ladder with the five-seed
  member-noise band, open markers the frozen \BoundarySplit{} values; (top right)
  the filter against the fixed-lag smoother; (bottom) the band-scale calibration
