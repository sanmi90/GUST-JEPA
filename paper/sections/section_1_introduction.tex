...
$H = 16$ while the predictive and linear rollouts remain within it, and the
departure is along directions of negligible encoded variance, which reconciles the
small Euclidean drift of the reconstructive rollout with its large Mahalanobis
departure (\S\ref{sec:res_drift}). We add a topological statement on the cleanest
