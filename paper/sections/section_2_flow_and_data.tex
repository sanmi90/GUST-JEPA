...
Without a gust, the $\alpha = 14^\circ$ wake at this Reynolds number is separated and sheds periodically; in dynamical terms the undisturbed
...
and the family ordering is unchanged, so the per-encounter clip does not drive the result.
...
available because the full DNS field happens to exist.
