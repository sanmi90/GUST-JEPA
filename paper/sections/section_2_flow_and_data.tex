...
spanwise-oriented Taylor vortex released upstream of the leading edge. The
governing data are the spanwise-periodic simulations of Fukami, Smith \& Taira
\cite{fukami2025prf}, in which the same configuration was characterised in
detail. % CHECK: that source describes the data as large-eddy simulation; the
% present text says "numerical simulation" pending confirmation of DNS vs LES.
...
frames at $\Delta t = 0.05\,t/c$, one encounter per gust release. The dataset
...
strengths, the three core diameters, and the two source groups; test\_c is the
