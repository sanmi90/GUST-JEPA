...
% Appendices (scaffold): A. encoder/predictor architecture detail and the
% SIGReg/VICReg anti-collapse comparison; B. probe and bootstrap protocol;
% C. deployment-oriented pressure-to-latent estimation and the closed-loop
% pilot (negative result); D. trajectory-geometry supplementary diagnostics.
