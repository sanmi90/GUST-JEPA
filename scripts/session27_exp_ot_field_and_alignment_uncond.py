...
DECODED_DIR = REPO / "outputs" / "session27" / "decoded_noc_tf"
OUT_DIR = REPO / "outputs" / "session27" / "ot_noc_tf"
MANIFEST = REPO / "outputs" / "data_pipeline" / "v1" / "manifest.json"

# Latent sources (z_full = per-frame latent trajectory, (n, 120, d)).
_NOC = REPO / "outputs" / "session27" / "latents_own_jepa_noc_tf" / "test_b.npz"
LATENTS = {
