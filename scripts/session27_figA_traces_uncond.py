...
#   probe fit on outputs/session27/latents_own_jepa_noc_tf/train.npz,
#   rollouts from outputs/session27/rollouts_noc_tf/{split}.npz.
...
OUT_PDF = REPO / "outputs/session27/figs_uncond/figA_traces.pdf"
OUT_PNG = REPO / "outputs/session27/figs_uncond/figA_traces.png"
...
FAM_DIRS = {
    "jepa": (SESSION27 / "latents_own_jepa_noc_tf", SESSION27 / "rollouts_noc_tf"),
...
FAMS = [("jepa", "noc_tf"), ("fukami", "fukami_d64_noBN"),
        ("pod", "pod_d64_noBN")]
