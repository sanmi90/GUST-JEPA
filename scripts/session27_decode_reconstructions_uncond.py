...
ENC_CKPT_D32 = REPO / "outputs/session27/JEPA_d64_noc_tf/checkpoint_iter020000.pt"
DEC_CKPT_D32 = REPO / "outputs/session27/decoder_noc_tf/decoder_iter030000.pt"
...
def main():
    ...
    ap.add_argument("--out", type=Path, default=REPO / "outputs/session27/decoded_noc_tf")
    args = ap.parse_args()
