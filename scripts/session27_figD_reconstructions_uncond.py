...
DEC = REPO / "outputs/session27/decoded_noc_tf"
OUT_PDF = REPO / "outputs/session27/figs_uncond/figD_reconstructions.pdf"
OUT_PNG = REPO / "outputs/session27/figs_uncond/figD_reconstructions.png"
