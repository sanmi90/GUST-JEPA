...
# SESSION27 UNCONDITIONED VARIANT of scripts/session21/fig9_scale.py.
# Same triptych + staged-enstrophy plot; reads the unconditioned scale_decomp.json
# and the unconditioned decoded test_b fields.
REPO = Path(__file__).resolve().parents[1]  # session27 copy lives directly under scripts/
sys.path.insert(0, str(REPO / "scripts/session21"))
import figstyle as fs  # noqa: E402

SD = REPO / "outputs/session27/scale_decomp_noc_lstm/scale_decomp.json"
DEC = REPO / "outputs/session27/decoded_noc_lstm/test_b.npz"
OUT_PDF = REPO / "outputs/session27/figs_uncond_lstm/fig_scale_decomp.pdf"
OUT_PNG = REPO / "outputs/session27/figs_uncond_lstm/fig_scale_decomp.png"
