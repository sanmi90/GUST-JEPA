...
#   LAT -> outputs/session27/latents_own_jepa_noc_lstm (plural keys),
#   DEC -> outputs/session27/decoded_noc_lstm/test_b.npz.
...
LAT = REPO / "outputs/session27/latents_own_jepa_noc_lstm"
DEC = REPO / "outputs/session27/decoded_noc_lstm/test_b.npz"
OUT_PDF = REPO / "outputs/session27/figs_uncond_lstm/figC_cycle.pdf"
OUT_PNG = REPO / "outputs/session27/figs_uncond_lstm/figC_cycle.png"
