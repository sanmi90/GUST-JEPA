...
OTJ = REPO / "outputs/session27/ot_noc_tf/ot_results.json"
SHEP = REPO / "outputs/session27/ot_noc_tf/shepard_data.npz"
OUT_PDF = REPO / "outputs/session27/figs_uncond/fig_ot.pdf"
OUT_PNG = REPO / "outputs/session27/figs_uncond/fig_ot.png"
