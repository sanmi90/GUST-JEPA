...
from session27_exp_persistent_homology_uncond import (  # noqa: E402
    FUKAMI_TAG, JEPA_TAG, NOISE_FRAC, TAG_ROOTS, ROLLOUTS_ROOT, loop_summary, rips_h1,
)

OUT_PDF = REPO / "outputs/session27/figs_uncond/fig_persistence.pdf"
OUT_PNG = REPO / "outputs/session27/figs_uncond/fig_persistence.png"
PVAL = 4.95e-9   # Mann-Whitney one-sided, from session27 persistent_homology_noc_tf.json
