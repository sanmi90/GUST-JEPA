...
SD = REPO / "outputs/session27/scale_decomp_noc_tf/scale_decomp.json"
DEC = REPO / "outputs/session27/decoded_noc_tf/test_b.npz"
OUT_PDF = REPO / "outputs/session27/figs_uncond/fig_scale_decomp.pdf"
OUT_PNG = REPO / "outputs/session27/figs_uncond/fig_scale_decomp.png"
