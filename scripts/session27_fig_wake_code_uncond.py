...
# UNCONDITIONED: read the unconditioned cross-encoder JSON; the JEPA bars are the
# unconditioned tf-no-c latent, Fukami/POD are the production baselines.
J = json.loads(Path("outputs/session27/causal_noc_tf/cross_encoder3.json").read_text())
FAM = ["JEPA", "Fukami", "POD"]
...
out = Path("outputs/session27/figs_uncond/fig_wake_code.pdf")
