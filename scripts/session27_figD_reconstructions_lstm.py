...
# SESSION27 UNCONDITIONED VARIANT of scripts/session21/figD_reconstructions.py.
# Only the input decoded dir + output paths differ; figstyle is reused unchanged.
REPO = Path(__file__).resolve().parents[1]  # session27 copy lives directly under scripts/
sys.path.insert(0, str(REPO / "scripts/session21"))
import figstyle as fs  # noqa: E402

DEC = REPO / "outputs/session27/decoded_noc_lstm"
OUT_PDF = REPO / "outputs/session27/figs_uncond_lstm/figD_reconstructions.pdf"
OUT_PNG = REPO / "outputs/session27/figs_uncond_lstm/figD_reconstructions.png"
