...
# outputs/session27/latents_own_jepa_noc_tf, the JEPA rollouts from
# outputs/session27/rollouts_noc_tf. The reconstructive (Fukami) reference is kept
...
DNS_LATENTS = SESSION27_ROOT / "latents_own_jepa_noc_tf"
ROLLOUTS_ROOT = PROD_ROLLOUTS_ROOT  # default root (Fukami lives here)
OUT_DIR = SESSION27_ROOT / "phase_amplitude_noc_tf"
