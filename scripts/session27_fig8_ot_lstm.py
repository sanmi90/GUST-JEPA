...
# SESSION27 UNCONDITIONED VARIANT of scripts/session21/fig8_ot.py.
# Same two-panel OT figure; reads the unconditioned OT results + shepard arrays.
REPO = Path(__file__).resolve().parents[1]  # session27 copy lives directly under scripts/
sys.path.insert(0, str(REPO / "scripts/session21"))
import figstyle as fs  # noqa: E402

OTJ = REPO / "outputs/session27/ot_noc_lstm/ot_results.json"
SHEP = REPO / "outputs/session27/ot_noc_lstm/shepard_data.npz"
OUT_PDF = REPO / "outputs/session27/figs_uncond_lstm/fig_ot.pdf"
OUT_PNG = REPO / "outputs/session27/figs_uncond_lstm/fig_ot.png"
