...
# outputs/session27/rollouts_noc_tf, while the reconstructive (Fukami) reference is
...
OUT_DIR = REPO / "outputs" / "session27" / "persistent_homology_noc_tf"

# The unconditioned predictive rollouts live at outputs/session27/rollouts_noc_tf,
# i.e. tag "noc_tf" under the session27 root. Fukami keeps the production tag/root.
JEPA_TAG = "noc_tf"
